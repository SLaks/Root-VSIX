...
namespace Root_VSIX
{
    class ProgramOptions
    {
        ...
        [Option("rootSuffix", Required = true, HelpText = "The root suffix of Visual Studio to install into.")]
        ...
        public string GetUsage()
        {
            ...
            help.AddPreOptionsLine("Installs local VSIX extensions to custom Visual Studio RootSuffixes" + Environment.NewLine);
